        ...
        <div className="flex justify-center space-x-2 overflow-x-auto pb-4">
          {images.map((image, index) => (
            <button
              ...
              className={`flex-shrink-0 w-20 h-20 rounded-lg overflow-hidden border-2 transition-all duration-300 ${currentIndex === index ? 'border-blue-500 scale-110' : 'border-transparent hover:border-blue-300'
                }`}
            >
              <ImageWithFallback
                src={image.src}
